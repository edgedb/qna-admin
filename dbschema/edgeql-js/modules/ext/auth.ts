...
export type $IdentityλShape = $.typeutil.flatten<$AuditableλShape & {
  ...
  "<identity[is Moderator]": $.LinkDesc<_default.$Moderator, $.Cardinality.AtMostOne, {}, true, false,  false, false>;
  "<identity[is __default::current_moderator]": $.LinkDesc<___default.$current_moderator, $.Cardinality.Many, {}, false, false,  false, false>;
  "<identity[is current_moderator]": $.LinkDesc<_default.$current_moderator, $.Cardinality.Many, {}, false, false,  false, false>;
